...
\begin{document}
	...
	\begin{lemma}[Properties of $\ncat{Ring}$ and $\ncat{CRing}$]
		...
		\begin{enumerate}[(i)]
			...
			\vbox{\item{
				Both $\ncat{Ring}$ and $\ncat{CRing}$ are complete categories.

				Products of rings $(R_i)_{i \in I}$ are given by componentwise ring structure on the product $\smash{\Prod \limits_{i \in I} R_i}$ of the underlying sets.
