		...
		\begin{equation*}
			\begin{diagram}
				\fivebythree[verywide]
					{}{}{(A_1,B)}{}{(A_1,A_1\intersection A_2)}
					{(A_1 \intersection A_2)}{(A_1 \intersection A_2, B)}{}{(X,B)}{(X,A_2)}
					{}{}{(A_2,B)}{}{}

					\arrow{w}{n}{i_1}[above left]
					\arrow{w}{s}{i_2}[below left]
					\arrow{n}{e}{j_1}[above right]
					\arrow{s}{e}{j_2}[below right]
					\arrow{e}{ee}{b}[above]
					\arrow{nee}{ee}{e}[left]
					\arrow{ww}{w}{a}[above]
					\arrow{n}{nee}{\widetilde{b}}[above]
			\end{diagram}
		\end{equation*}
