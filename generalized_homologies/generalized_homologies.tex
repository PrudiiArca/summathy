...
\begin{document}
	...
	\begin{lemma}[Homology of Mapping Telescope]
		Let $(H_\bullet, \partial_\bullet)$ be a generalized homology theory and let $X_0 --> X_1 --> ... --> X = \colim \limits_{n \in \N_0} X_n$ be a linearly filtered diagram of topological spaces. Then we have a canonical isomorphism
		\begin{equation*}
